...
import type { Category as _Category, Tip as _Tip } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async addTip(arg0: string, arg1: string, arg2: Category): Promise<Tip> {
        if (this.processError) {
            try {
                const result = await this.actor.addTip(arg0, arg1, to_candid_Category_n1(this._uploadFile, this._downloadFile, arg2));
                return from_candid_Tip_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
...
function from_candid_Tip_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Tip): Tip {
...
function from_candid_variant_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "mental" in value ? Category.mental : "food" in value ? Category.food : "exercise" in value ? Category.exercise : "routine" in value ? Category.routine : value;
}
function from_candid_vec_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Tip>): Array<Tip> {
    return value.map((x)=>from_candid_Tip_n3(_uploadFile, _downloadFile, x));
}
